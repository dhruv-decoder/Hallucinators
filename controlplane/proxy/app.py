...
def create_app(recorder_path: str | None = "recorder_log.jsonl", force_simulated: bool = False) -> FastAPI:
    ...
    async def chat_completions(req: ChatCompletionRequest, request: Request):
        ...
        try:
            ...
            raise HTTPException(status_code=503, detail="ControlPlane is busy; retry shortly", headers={"Retry-After": "1"}) from exc
...
def _stream_completion(service: OversightService, gen: Generation, prompt: str, model: str, request_id: str | None = None):
