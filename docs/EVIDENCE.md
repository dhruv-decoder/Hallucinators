...
Rule: no number or named technique ships in a slide, the README, or the demo unless it links to a primary
source here, or is regenerated by `make eval`. Keep this brutally honest: one fabricated stat in Q&A
destroys trust.
